...
#           AGORA O CÓDIGO PODE SER OTIMIZADO E REFATORADO, 
#           RESUMINDO OS COMANDOS PARA SELECIONAR A CÉLULAS ONDE SERÁ FEITA A PESQUISA PARA APANAS UM 
#           CLIQUE NA OPÇÃO PARA SELECIONAR TODAS AS CÉLULAS (1ª CÉLULA NO CANTO SUPERIOR ESQUERTO DA PLANILHA).
